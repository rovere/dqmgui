...
#include "DQM/regExpDefinition.h"
...
extern pthread_rwlock_t parentslock;
extern StringAtomParentList parents;
...
std::string
axisStatsToJSON(uint32_t nbins[3], double mean[3],
...
extern inline bool orderSamplesByDataset(const VisDQMSample &a, const VisDQMSample &b);
extern inline bool orderSamplesByRun(const VisDQMSample &a, const VisDQMSample &b);
