...
//<EOF This static functions could be potentially gathers alltogher into a single .o
//////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////
static void
...
//WARNING: all the following REGEXP are only used by the next 2 arrays, nowhere else.
...
//<EOF2 The following class (VisDQMRenderLink) is a standalone one
//that only need the static declaration of its single instance.
// read http://stackoverflow.com/questions/8623657/multiple-instances-of-singleton-across-shared-libraries-on-linux
